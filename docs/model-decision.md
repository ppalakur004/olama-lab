...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|---|
| mistral | `summarize.v1` | 12/12 | 59/60 | 1/60 | 17/63 | 8/12 | 4/12 | 8/12 | 0/12 | 0/1 | 1/12 | 0 | 13857 / 3793 | 12916 / 16346 ms |
| qwen | `summarize.v1 transfer` | 11/12 | 55/60 | 0/60 | 0/56 | 11/12 | 1/12 | 10/12 | 0/12 | 1/1 | 1/12 | 1 | 11838 / 11482 | 31512 / 89785 ms |

- **Decision:** summarization → mistral → `summarize.v1`
- **Why:** all 12 valid vs Qwen 11/12 (truncated). Better recall (59/60 vs 55/60) and citations (17/63 vs 0/56). Faster. Citations are still weak on both.
...
| qwen | `extract.v2 transfer` | 11/12 | 66/72 | 0/72 | 14/68 | 10/12 | 2/12 | 9/12 | 0/12 | 1/1 | 2/12 | 1 | 17936 / 17820 | 47091 / 94051 ms |

- **Decision:** extraction → mistral → `extract.v2`
- **Why:** all 12 valid vs Qwen 11/12 (truncated). Better recall (71/72 vs 66/72) and citations (49/76 vs 14/68). Much faster. Citations are still a gap.

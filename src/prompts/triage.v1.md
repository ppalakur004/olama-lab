...
Return only a JSON object that validates against TriageOutput. Do not include an analysis field. Do not add keys that are not in the schema.
...
Required keys: queue, escalation_required, confidence, rationale, draft_reply, human_review_required, customer_outcome.

Do not include analysis. Do not wrap the JSON in Markdown. Do not add commentary before or after it.

Example shape (values are illustrative only):
{"queue": "card_dispute", "escalation_required": false, "confidence": 0.7, "rationale": "Recognized duplicate charge.", "draft_reply": "A specialist will review the duplicate charge.", "human_review_required": true, "customer_outcome": null}
